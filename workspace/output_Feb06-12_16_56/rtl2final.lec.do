...
# Generated on: Fri Feb 06 12:17:07 IST 2026 (Fri Feb 06 06:47:07 UTC 2026)
...
set logfile log/rtl2final.lec.log ;# user can modify this name for succeeding runs
...
set_verification_information fv_map_cic_mv_db

read_implementation_information fv/cic -golden fv_map -revised cic_mv
...
read_library -liberty -both \
    /home/rdpuser/digital_anuj/cic_adi/workspace/../lib/typical.lib \
    /home/rdpuser/digital_anuj/cic_adi/workspace/../lib/typical.lib

read_design -verilog95   -golden -lastmod -noelab fv/cic/fv_map.v.gz
elaborate_design -golden -root {cic}

read_design -verilog95   -revised -lastmod -noelab output_Feb06-12:16:56/cic_m.v
elaborate_design -revised -root {cic}

#add_name_alias fv/cic/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/cic/cic_mv.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.cic.fv_map.cic_mv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.cic.fv_map.cic_mv.rpt
}
report_test_vector -noneq > noneq.test_vector.cic.fv_map.cic_mv.rpt
...
read_implementation_information fv/cic -revised fv_map
...
add_search_path . /home/rdpuser/digital_anuj/cic/hdl -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/rdpuser/digital_anuj/cic/hdl/cic.v
elaborate_design -golden -root {cic} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/cic/fv_map.v.gz
elaborate_design -revised -root {cic}
...
#add_name_alias fv/cic/fv_map.singlebit.original_name.alias.json.gz -revised
#set_mapping_method -alias -revised
#add_renaming_rule r1alias _reg((\\\[%w\\\])*(/U\\\$%d)*)$ @1 -type dff dlat -both
...
write_compared_points noneq.compared_points.cic.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.cic.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.cic.rtl.fv_map.rpt
write_verification_information
report_verification_information
